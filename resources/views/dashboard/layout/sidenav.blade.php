<div class="relative">
    <button id="sidenav-triger-btn" name=""
        class="aboslute w-6 z-10 sidenav-button right-0 mt-[4.8rem] translate-x-3 shadow-lg rotate-180 flex items-center justify-center h-6 rounded-full bg-black text-white absolute">
        ...
        <div class="flex flex-1 flex-col gap-10 px-3 justify-between">
            ...
            <div class="flex pt-8 flex-col ">
                ...
                <div class="py-2 flex flex-col gap-3 border-gray-200 border-b">
                    ...
                    <button id="employees_button" name="employees"
                        class="flex sidenav-button cursor-pointer @if (implode('/', array_slice(explode('/', url()->current()), 4, 1)) == 'employees') bg-white border text-black @endif  items-center btn-icon py-1 justify-between px-2 rounded-xl ">
                    ...
                    <div id="employees" class="h-0 cursor-pointer mb-3 overflow-hidden hidden">
                        <div class="  flex flex-col ms-[1.15rem]">
                            <button id="head_button" name="head"
                                class="flex cursor-pointer sidenav-button justify-between border-l @if (implode('/', array_slice(explode('/', url()->current()), 4, 2)) == 'employees/head_employees') !border-black before:!bg-black @elseif (implode('/', array_slice(explode('/', url()->current()), 4, 2)) == 'employees/branch_employees') !border-black @endif  border-stone-300 py-2.5 relative items-center before:bg-stone-300 before:left-0 before:w-3 before:h-[0.05rem] before:absolute gap-2 ps-5 pe-2 ">
                                <span>Head</span>
                        ...
                        <div class=" flex flex-col ms-[1.15rem]">
                            <button id="branch_button" name="branch"
                                class="flex cursor-pointer sidenav-button justify-between border-l @if (implode('/', array_slice(explode('/', url()->current()), 4, 2)) == 'employees/branch_employees' ||
                ...
                <div class="py-2 flex flex-col gap-3 border-gray-200 border-b">
                    ...
                    <button name="pdlmonitor"
                        class="flex items-center sidenav-button btn-icon py-1 justify-between px-2 rounded-xl ">
                        <div class="flex items-center gap-2">
                            <span class="">
