...
async function fetchdata() {
    ...
    if (tailwindpagination) {
        tailwindpagination.classList.add("w-full", "mt-5", "mb-5", "gap-4", "items-center", "justify-center");
        if (data.length > 10) {
            tailwindpagination.classList.toggle("flex");
            tailwindpagination.classList.toggle("hidden");
        }
    }
}
